                        ...
                        <ul class="timeline">
                            ...
                            <li>
                                ...
                                <div class="timeline-panel">
                                    ...
                                    <div class="timeline-body mt-3">
                                        <p>
                                            <i class="fa-solid fa-spinner fa-spin-pulse"></i> Aguarde, seu contador(a) está
                            ...
                            <li class="timeline-inverted">
                                ...
                                <div class="timeline-panel">
                                    ...
                                    <div class="timeline-body mt-3">
                                        <p>Após colher assinatura do canditato, envie-nos para finalizarmos o processo.</p>
                                    </div>
                                    @component('components.upload-file')
                                    @endcomponent
                                    <script src="{{ asset('build/js/upload-file.js') }}"></script>
                                ...
                                <div class="timeline-panel">
                                    ...
                                    <div class="timeline-body mt-3">
                                        <p>
                                            ...
                                            experiência, com vigência até 05/04/2023, podendo ser prorrogado até 25/07/2023.
                                    ...
                                    <button class="btn btn-success mt-3" disabled>Ficha do funcionário</button>
                                </div>
                            </li>
                            <li class="timeline-inverted">
                            ...
                            <li class="timeline-inverted">
                                ...
                                <div class="timeline-panel">
                                    ...
                                    <div class="timeline-body mt-3">
                                        <p>Após colher assinatura do funcionário, envie-nos para finalizarmos o processo.
                                        </p>
                                    </div>
                                    <!-- anexo -->
                                    @component('components.upload-file')
