    ...
    Route::middleware('auth')->group(function () {
        ...
        Route::patch('funcionarios/recrutamento/etapas/{funcionario}/pedido-rescisão', [FolhaRecrutamentoController::class, 'pedidoRescisao'])->name('recrutamento.pedidoRescisao');
    ...
    Route::get('notificacoes', [ClientDashboardController::class, 'viewAllNotification'])->name('view-all-notification');


    /** Rotas Organizar */
    Route::resource('guia-pagamento', GuiapagController::class, [
        'names' => [
            'index' => 'guiapag.index',
        ],
    ]);
